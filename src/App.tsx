...
import CertificateSignerPage from './pages/gestor/CertificateSignerPage';
import CertificateBulkPage from './pages/gestor/CertificateBulkPage';
import CertificateUploadPage from './pages/gestor/CertificateUploadPage';
    ...
    <>
      <Routes>
        ...
        <Route path="/gestor" element={<GestorLayout />}>
          ...
          <Route path="assinador" element={<CertificateSignerPage />} />
          <Route path="disparo" element={<CertificateBulkPage />} />
          <Route path="upload-certificado" element={<CertificateUploadPage />} />
        </Route>
