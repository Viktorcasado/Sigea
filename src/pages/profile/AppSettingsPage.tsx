...
import { ArrowLeft, Moon, Sun, Globe, BellRing, Monitor } from 'lucide-react';
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 px-1">
              ...
              <h2 className="text-xs font-black text-gray-400 uppercase tracking-wider">Aparência</h2>
            </div>
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center gap-2 p-4 rounded-2xl border-2 transition-all ${
                      isActive 
                        ...
                        : 'border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800 text-gray-500'
                    }`}
                  >
