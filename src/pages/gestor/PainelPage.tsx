import { PlusCircle, ShieldCheck, FileBarChart, History, Send, FileUp } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Link to="/gestor/disparo" className="flex items-center gap-3 bg-white p-4 rounded-xl shadow-sm hover:bg-gray-50">
            <Send className="w-6 h-6 text-indigo-600" />
            <span className="font-semibold text-gray-700">Disparo em Massa</span>
          </Link>
          <Link to="/gestor/upload-certificado" className="flex items-center gap-3 bg-white p-4 rounded-xl shadow-sm hover:bg-gray-50">
            <FileUp className="w-6 h-6 text-indigo-600" />
            <span className="font-semibold text-gray-700">Subir Certificado</span>
          </Link>
